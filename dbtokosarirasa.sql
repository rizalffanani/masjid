...
--
-- Host: localhost
-- Waktu pembuatan: 30 Jun 2021 pada 23.46
...
(1, 'TOKO SARI RASA', 'SISTEM INFORMASI  PENJUALAN KERIPIK\r\nDI  TOKO SARI RASA BERBASIS WEB', 'TOKO SARI RASA', 'Jl. Sanan Gg. III No.168, <br> Purwantoro, Kec. Blimbing, Kota Malang, <br> Jawa Timur 65126', 'tokosarirasa@gmail.com', '0813-3378-2544', '1file_01072021043944.png');
...
(84, 'Laporan', 'admin/kas', 'Laporan Transaksi', 'fa fa-laptop', 1, 0, 'menu'),
...
INSERT INTO `order` (`id_order`, `id_user`, `diskon`, `total_harga`, `bayar`, `date`, `waktu`, `transaksi`, `id_kasir`, `nama_kasir`, `metode`, `status`, `id_lokasi`, `lokasi`, `catatan`, `bukti`) VALUES
(1, '2', '', '26000', '26000', '2021-05-05', '12:10:22', 'diterima', 1, 'admin1', 'tunai', 'lunas', 8, 'Fakultas Pendidikan', 'baik', NULL),
(2, '2', '', '13000', '13000', '2021-05-05', '12:39:04', 'dikirim', 1, 'admin1', 'tunai', 'lunas', 14, ' Perpustakaan UM', 'sdfsdf', NULL),
(3, '2', '', '26000', '26000', '2021-06-19', '10:26:02', 'diterima', 1, 'admin1', 'tunai', 'lunas', 0, NULL, '', NULL),
(4, '2', '', '13000', '13000', '2021-06-19', '11:03:15', 'diterima', 1, 'admin1', 'tunai', 'lunas', 0, NULL, 'hgfhdfgh', NULL),
(5, '2', '', '13000', '13000', '2021-06-19', '11:05:23', 'diterima', 1, 'admin1', 'tunai', 'lunas', 0, NULL, 'cxczv', NULL),
(6, '2', '', '13000', '13000', '2021-06-19', '11:11:12', 'terkonfirmasi', 1, 'admin1', 'tunai', 'lunas', 0, NULL, 'gfdgdfg', NULL),
(7, '2', '', '7500', '7500', '2021-06-19', '12:34:02', 'terkonfirmasi', 1, 'admin1', 'tunai', 'lunas', 0, NULL, '', NULL),
(8, '3', '', '46500', '46500', '2021-06-19', '13:40:05', 'diterima', 1, 'admin1', 'tunai', 'lunas', 0, NULL, 'fdgdfg', NULL),
(9, '2', '', '13000', '13000', '2021-06-20', '22:59:46', 'terkonfirmasi', 1, 'admin1', 'debit', 'lunas', 0, NULL, 'Perum Bamban Samudra B06 Malang', NULL),
(10, '2', '', '900', '900', '2021-07-01', '04:35:33', 'diterima', 1, 'admin1', 'debit', 'lunas', 0, NULL, 'malang', '10file_01072021044300.png');
...
(12, 10, 53, 'tes', 7, 'tes', 1, 900, 900, '928file_19062021134343.jpg');
...
--
-- Stand-in struktur untuk tampilan `view_notif`
-- (Lihat di bawah untuk tampilan aktual)
--
...
--
ALTER TABLE `order`
  MODIFY `id_order` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
