<div class="row" style="margin-bottom: 10px">
            <div class="col-md-4">
                <?php echo anchor(site_url('admin/t_jadwal/create'), 'Create', 'class="btn btn-primary"'); ?>
            </div>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                var t = $("#mytable").dataTable({
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: {"url": "<?php echo base_url() ?>admin/t_jadwal/json", "type": "POST"},
                    columns: [
                        {
                            "data": "id_jadwal",
                            "orderable": false
                        },{"data": "tgl"},{"data": "jam"},{"data": "nama_kegiatan"},{"data": "deskripsi"},
                        {
                            "data" : "action",
                            "orderable": false,
