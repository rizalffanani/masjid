<div class="row" style="margin-bottom: 10px">
            <div class="col-md-4">
                <?php echo anchor(site_url('admin/t_buletin/create'), 'Create', 'class="btn btn-primary"'); ?>
            </div>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                var t = $("#mytable").dataTable({
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: {"url": "<?php echo base_url() ?>admin/t_buletin/json", "type": "POST"},
                    columns: [
                        {
                            "data": "id_buletin",
                            "orderable": false
                        },{"data": "judul_b"},{"data": "id_user"},{"data": "date"},{"data": "time"},{"data": "id_kate"},
                        {
                            "data" : "action",
                            "orderable": false,
