<form action="<?php echo $action; ?>" method="post">
    ...
    <div class="form-group">
        ...
        <textarea class="form-control" rows="3" name="deskprisi" id="deskprisi"
            placeholder="Deskprisi"><?php echo $deskprisi; ?></textarea>
    </div>
    <div class="form-group">
        <label for="enum">Jenis <?php echo form_error('jenis') ?></label>
        <select class="form-control" name="jenis" id="jenis">
            <option value="pengeluaran" <?php echo $retVal = ($jenis=="pengeluaran") ? "Selected" : "" ; ?>>Pengeluaran
            </option>
            <option value="pemasukan" <?php echo $retVal = ($jenis=="pemasukan") ? "Selected" : "" ; ?>>Pemasukan
            </option>
        </select>
    </div>
    <div class="form-group">
