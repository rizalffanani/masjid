<div class="row" style="margin-bottom: 10px">
            <div class="col-md-4">
                <?php echo anchor(site_url('admin/t_sholat/create'), 'Create', 'class="btn btn-primary"'); ?>
            </div>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                var t = $("#mytable").dataTable({
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: {"url": "<?php echo base_url() ?>admin/t_sholat/json", "type": "POST"},
                    columns: [
                        {
                            "data": "id_sholat",
                            "orderable": false
                        },{"data": "waktu_sholat"},{"data": "hari"},{"data": "imam"},{"data": "muadzin"},
                        {
                            "data" : "action",
                            "orderable": false,
