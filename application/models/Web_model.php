...
class Web_model extends CI_Model
{
    ...
    {
        $this->db->order_by("id_kate", "DESC");
        return $this->db->get("t_kategori")->result();
    }

    function get_row_kategori($id)
    {
    ...
    {
        $this->db->order_by("id_buletin", "DESC");
        return $this->db->get("t_buletin")->result();
    }

    function get_all_katbuletin($id)
    {
        $this->db->where("id_kate", $id);
        $this->db->order_by("id_buletin", "DESC");
        return $this->db->get("t_buletin")->result();
    ...
    function get_product_keyword($keyword){
        $this->db->select('*');
        $this->db->from('t_buletin');
        $this->db->like('judul_b',$keyword);
